...
class YcbineoatReader:
  ...
  def get_mask(self,i):
    mask_file = self.color_files[i].replace('rgb','masks').replace('.jpg','.png')
  ...
  def get_depth(self,i):
    depth_file = self.color_files[i].replace('rgb','depth').replace('.jpg','.png')
  ...
  def get_occ_mask(self,i):
    hand_mask_file = self.color_files[i].replace('rgb','masks_hand').replace('.jpg','.png')
    ...
    right_hand_mask_file = self.color_files[i].replace('rgb','masks_hand_right').replace('.jpg','.png')
